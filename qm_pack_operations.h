...
struct pack_concatenation<std::tuple<Ts...>,T...>
{
...
template <class,class> struct pack_append;

template<class... Xs, class... Us>
struct pack_append<Cs<Xs...>,Cs<Us...>>
{
  using type=Cs<pack_concatenation_t<Cs<Xs...>,Us>...>;
};


template<class A, class B>
using pack_append_t=typename pack_append<A,B>::type;
...
template<class One,class Two> struct pack_intesection;


template<class... Ts>
struct pack_intesection<Cs<>,Cs<Ts...>>
{
  typedef Cs<> type;
};
...
struct pack_intesection<Cs<Ts...>,Cs<Us...>>
{
  typedef pack_concatenation_t<
      std::conditional_t<
          (is_in_pack<Ts,Us...>()),Cs<Ts>,Cs<>
...
template<class One,class Two>
using pack_intersection_t =typename pack_intesection<One,Two>::type;
...
template<class > struct pack_flatten;

template<class T> using pack_flatten_t=typename pack_flatten<T>::type;


template<class T>
struct pack_flatten{using type=T;};


template<class... Ts>
struct pack_flatten<Cs<Ts...>>
{
  using type= pack_concatenation_t<
      Cs<>,pack_flatten_t<Ts>...>;
};
...
template<class...Ts0, class ...Ts2, class ...Ts3, std::size_t... I0, std::size_t... I1,std::size_t... I2>
std::tuple<std::tuple<Ts0...>, std::tuple<Ts2...>, std::tuple<Ts3...>>
distribute(Cs<Ts0...>,Cs<Ts2...>,std::tuple<Ts0...,Ts2...,Ts3...>&& tu,
           std::index_sequence<I0...>, std::index_sequence<I1...>, std::index_sequence<I2...>)
{
  return std::tuple(std::tuple<Ts0...>{std::get<I0>(std::move(tu))...},
                    std::tuple<Ts2...>{std::get<sizeof... (Ts0)+I1>(std::move(tu))...},
                    std::tuple<Ts3...>{std::get<sizeof... (Ts0)+sizeof... (Ts2)+I1>(std::move(tu))...});

}
template<class...Ts0, class ...Ts2, class ...Ts3>
std::tuple<std::tuple<Ts0...>, std::tuple<Ts2...>, std::tuple<Ts3...>>
distribute(Cs<Ts0...>,Cs<Ts2...>,Cs<Ts3...>,std::tuple<Ts0...,Ts2...,Ts3...>&& tu)
{
  return distribute(Cs<Ts0...>{}, Cs<Ts2...>{}, Cs<Ts3...>{},std::move(tu),std::index_sequence_for<Ts0...>{}, std::index_sequence_for<Ts2...>{}, std::index_sequence_for<Ts3...>{});
}
