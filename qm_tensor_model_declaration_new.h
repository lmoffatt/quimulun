#ifndef QM_TENSOR_MODEL_DECLARATION_NEW_H
#define QM_TENSOR_MODEL_DECLARATION_NEW_H
...
template<class T> struct Result_value
{
  using type=Result<T>;
  using result_type=T;
...
template<class T> using Result_value_t=typename Result_value<T>::type;
...
template<class ...>class Update_new;


template<class Id,class G, class Y, class ...Ops,class ...Xs>
class  Update_new<Id,G,Arguments<Y>, Operations<Ops...>,Arguments<Xs...>>
{
private:
  G g_;
public:
  ...
  Update_new(Id ,G&& g, Arguments<Y>&&,Operations<Ops...>&&, Arguments<Xs...>&&):g_{std::move(g)}{}
};

template<class Id,class G, class Y, class ...Ops,class ...Xs>
Update_new(Id ,G&& g, Arguments<Y>&&,Operations<Ops...>&&, Arguments<Xs...>&&)->Update_new<Id,G,Arguments<Y>, Operations<Ops...>,Arguments<Xs...>>;
...
template<class Id,class Calc,class... Fs, class... Xs>
struct  Fq_new<Id,Calc,quimulun<Fs...>,Arguments<Xs...>>
{
public:
  quimulun<Fs...> q;
  typedef   Id myId;
  ...
  auto& Fq()const {return q;}
  Fq_new()=default;
  Fq_new(Id&& ,Calc&&,quimulun<Fs...>&& qui, Arguments<Xs...>&&):q{std::move(qui)}{}
};


template<class Id,class Calc,class... Fs, class... Xs>
struct  Fq_new<Id,Calc,quimulun<Fs...>,Arguments_xi<Xs...>>
{
public:
  quimulun<Fs...> q;
  typedef   Id myId;
  ...
  auto& Fq()const {return q;}
  Fq_new()=default;
  Fq_new(Id&& ,Calc&&,quimulun<Fs...>&& qui, Arguments_xi<Xs...>&&):q{std::move(qui)}{}
};


template<class Id, class Calc,class Fi, class ...X_is,class... Xs>
struct  Fq_new<Id,Calc,Fi,Arguments_xi<X_is...>,Arguments<Xs...>>
{
public:
  auto &operator[](Id)const {return *this;}
  typedef   Id myId;
  ...
  Fq_new()=default;
  Fq_new(Id&& ,Calc&&,Fi&& ,Arguments_xi<X_is...>&&,Arguments<Xs...>&&){}
};
...
template<class Id,class Calc,class... Fs, class... Xs>
Fq_new(Id&& ,Calc&&,quimulun<Fs...>&& , Arguments<Xs...>&&)->Fq_new<Id,Calc,quimulun<Fs...>,Arguments<Xs...>>;
template<class Id,class Calc,class... Fs, class... Xs>
Fq_new(Id&& ,Calc&&,quimulun<Fs...>&& , Arguments_xi<Xs...>&&)->Fq_new<Id,Calc,quimulun<Fs...>,Arguments_xi<Xs...>>;


template<class Id,class Calc,class Fi, class...X_is,class... Xs>
Fq_new(Id&& ,Calc&&,Fi&& , Arguments_xi<X_is...>&& , Arguments<Xs...>&&)->Fq_new<Id,Calc,Fi, Arguments_xi<X_is...>,Arguments<Xs...>>;
...
struct  Dq_new<Id,Calc,Fi,Arguments<Xs...>,Arguments_xi<x_is...>>
{
public:
  typedef   Id myId;
  auto &operator[](Id)const {return *this;}
...
template<class Id,class Calc,class Fi, class... x_is,class... Xs>
Dq_new(Id&& ,Calc&&,Fi&& , Arguments<Xs...>&&, Arguments_xi<x_is...>&&)->Dq_new<Id,Calc,Fi,Arguments<Xs...>,Arguments_xi<x_is...>>;
...
template<class, class > struct q2Lambda;

template<class... Fs, class... Fout>
struct q2Lambda<Arguments<Fout...>, quimulun<Fs...>>
{

  q2Lambda(Arguments<Fout...>, quimulun<Fs...>){}
};
...
#endif // QM_TENSOR_MODEL_DECLARATION_NEW_H
