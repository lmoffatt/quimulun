                    ...
                    const v<std::size_t,dimension_less>& nw, std::mt19937::result_type seed, long int nsamples, const std::vector<std::size_t>& decimate_factor,const std::string& filename)
{
  ...
  auto initParameters_f=quimulun{
  ...
  auto candidate_to_current_f=quimulun{
  ...
  auto intial_Parameters_v=random_calculate(initParameters_f,random_v,modeldata,initwalkers_v);

  auto currentParameters_v=transfer(candidate_to_current_f, std::move(intial_Parameters_v));
